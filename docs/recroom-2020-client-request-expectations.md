...
| `rooms/visitedby/me` | Paged array/list of room summaries/details. Server-side Continue list hides private / limited rooms unless the requester owns the room. | EJDCNGBEICB:RecRoom.Async.IPromise`1<System.Collections.Generic.List`1<KLCOGEIGEBJ>> INKFBOEEKDA():EJDCNGBEICB.txt:1018 |
